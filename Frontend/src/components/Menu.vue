  ...
  <div>
    <header id="bot">
      <div class="nav-group left-nav">
        ...
        <button class="navigation">Горки</button>
        <button class="navigation">Поддержка</button>
      </div>
    ...
    <main class="main-content">
      <section class="hero-section">
        <img src="C:\Users\Kuliev Nizami\Desktop\AquaPark\Frontend\src\assets\Logo_menu.png" alt="Аквапарк" class="hero-bg" />
